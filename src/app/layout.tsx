  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="rl-fisioterapia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="RL Fisioterapia®️"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="rl-fisioterapia"
          data-primary-color="#4abdbb"
          defer
        ></script>
      </head>
